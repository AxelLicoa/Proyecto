...
#megavatios de consumos para dicha ciudad en dicha planta.
    ...
    if n_planta == 'Coca Codo Sinclair':
        ...
        if n_ciudad == 'Quito':
            print('Total de MWh en Coca Codo Sinclair, Quito: ', tot_coca_codo_q, 'MWh')
            print('Con tarifa de: ', consumo_energia['Coca Codo Sinclair']['Quito']['tarifa'])
        elif n_ciudad == 'Guayaquil':
            print('Total de MWh en Coca Codo Sinclair, Guayaquil: ', tot_coca_codo_g, 'MWh')
    ...
    if n_planta == 'Sopladora':
        ...
        if n_ciudad == 'Quito':
            print('Total de MWh en Sopladora, Quito: ', tot_sopladora_q, 'MWh')
            print('Con tarifa de: ', consumo_energia['Sopladora']['Quito']['tarifa'])
        elif n_ciudad == 'Guayaquil':
            print('Total de MWh en Sopladora, Guayaquil: ', tot_sopladora_g, 'MWh')
            print('Con tarifa de: ', consumo_energia['Sopladora']['Guayaquil']['tarifa'])
        elif n_ciudad == 'Loja':
            print('Total de MWh en Sopladora, Loja: ', tot_sopladora_l)
            print('Con tarifa de: ', consumo_energia['Sopladora']['Loja']['tarifa'])
    else:
        print("La primera letra no está en mayusculas")
    print("Pasemos al consumo de Energia")
    exit
...
#no debería aparecer en el nuevo diccionario  
    ...
    print("Pasemos al dinero recaudado")
